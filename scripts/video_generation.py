...
# itself is the trigger, since it's prepended to EVERY shot's prompt
# verbatim and routinely contains ethnic-group names and genocide/war-crime
# context (Hutu, Tutsi, Bosniak, Serb, Nazi, SS, siege, ...).
